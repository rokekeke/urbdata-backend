...
from app.api.v1.routes.map_documents import router as map_documents_router
...
def create_app() -> FastAPI:
    ...
    application.include_router(map_documents_router, prefix=settings.api_v1_prefix)
    application.include_router(exports_router, prefix=settings.api_v1_prefix)
