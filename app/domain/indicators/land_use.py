...
# All four calculators below are pure and fully tested; only this constant
# and the LotAreaRecord assembly step depend on that still-open decision.
LOTE_LAYER = "lote"
...
def calculate_area_by_category(
    lots: Sequence[LotAreaRecord], *, metric_crs: str | int
